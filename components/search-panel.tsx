...
export function SearchPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Search modal */}
      <div className="relative w-full max-w-[540px] max-sm:max-w-full mx-4 max-sm:mx-0 rounded-2xl max-sm:rounded-none bg-card border border-border shadow-2xl flex flex-col max-h-[70vh] max-sm:max-h-[100dvh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Search input */}
