  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        {/* Tab bar */}
        <div className="flex px-5 pt-3 pb-0 gap-1 overflow-x-auto scrollbar-none" role="tablist">
          {TABS.map(tab => (
            <button
              key={tab.key}
              role="tab"
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-t-lg text-[11px] uppercase tracking-widest transition-colors border-b-2 shrink-0 ${
                activeTab === tab.key
