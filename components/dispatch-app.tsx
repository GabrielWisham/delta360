...
export function DispatchApp() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className={`flex flex-1 min-h-0 overflow-hidden ${store.portraitMode ? 'p-1.5 gap-1.5' : 'p-2 gap-2'}`}>
        <Sidebar />
        ...
        <main className="flex-1 flex flex-col min-h-0 overflow-hidden relative">
          ...
          <div className={`flex flex-1 min-h-0 overflow-hidden ${store.portraitMode ? 'flex-col gap-1.5' : 'gap-2 max-sm:flex-col'}`}>
